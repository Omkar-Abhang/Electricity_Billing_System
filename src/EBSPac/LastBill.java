    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(rs.next()){
                ...
                t1.append("\n    Meter Number:  "+rs.getInt("meter_number"));
            ...
            rs = c.s.executeQuery("select * from bill_table where meter_number="+c1.getSelectedItem());

            while(rs.next()){
                t1.append("       "+ rs.getString("month") + "           " +rs.getInt("amount") + "\n");
            }
